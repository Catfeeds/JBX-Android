...
package com.example.zhengdong.base.Section.Four.View.FilterHeaderView;
...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    public static final int POSITION_CATEGORY = 0; // 第一个txt的位置
    public static final int POSITION_SORT = 1; // 第二个txt的位置
    public static final int POSITION_FILTER = 2; // 第三个txt的位置
    ...
    public void resetViewStatus() {
        tvCategoryTitle.setTextColor(mContext.getResources().getColor(R.color.black));
        ivCategoryArrow.setImageResource(R.drawable.icon_dowm);

        tvSortTitle.setTextColor(mContext.getResources().getColor(R.color.black));
        ivSortArrow.setImageResource(R.drawable.icon_dowm);

        tvFilterTitle.setTextColor(mContext.getResources().getColor(R.color.black));
        ivFilterArrow.setImageResource(R.drawable.icon_dowm);
    }
...
//            viewMaskBg.getBackground().mutate().setAlpha(12);
        ...
        switch (position) {
            case POSITION_CATEGORY:
                tvCategoryTitle.setTextColor(mActivity.getResources().getColor(R.color.skyblue));
                ivCategoryArrow.setImageResource(R.drawable.icon_dowm);
                setCategoryAdapter();
                break;
            case POSITION_SORT:
                tvSortTitle.setTextColor(mActivity.getResources().getColor(R.color.skyblue));
                ivSortArrow.setImageResource(R.drawable.icon_dowm);
                setSortAdapter();
                break;
            case POSITION_FILTER:
                tvFilterTitle.setTextColor(mActivity.getResources().getColor(R.color.skyblue));
                ivFilterArrow.setImageResource(R.drawable.icon_dowm);
                setFilterAdapter();
                break;
        }
