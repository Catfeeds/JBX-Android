...
public class CustomSwitchView extends View {
    ...
    public interface OnStateChangedListener {
        void toggleToOn(CustomSwitchView view);

        void toggleToOff(CustomSwitchView view);
    }

    private OnStateChangedListener listener = new OnStateChangedListener() {
        @Override
        public void toggleToOn(CustomSwitchView view) {
            toggleSwitch(true);
        }

        @Override
        public void toggleToOff(CustomSwitchView view) {
            toggleSwitch(false);
        }
    };
