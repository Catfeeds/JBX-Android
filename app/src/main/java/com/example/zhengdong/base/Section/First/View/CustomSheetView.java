package com.example.zhengdong.base.Section.First.View;

/**
 * Created by dongzheng on 16/12/2.
 */
...
public class CustomSheetView extends Dialog {

    public CustomSheetView(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public CustomSheetView create() {
            final CustomSheetView dialog = new CustomSheetView(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            if (hasTitle) {
                ...
                viewDivider.setBackgroundColor(0xFFD8D8D8);
