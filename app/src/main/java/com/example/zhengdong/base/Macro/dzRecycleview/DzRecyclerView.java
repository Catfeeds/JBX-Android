...
public class DzRecyclerView extends RecyclerView {
    ...
    public DzRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DzRecyclerView(Context context, AttributeSet attrs, int defStyle) {
