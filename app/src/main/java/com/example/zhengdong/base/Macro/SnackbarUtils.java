...
public class SnackbarUtils {
     ...
     * @param actionTextColor 事件文本颜色
     */
    public static void showIndefiniteSnackbarx(View parent, CharSequence text, int duration, int textColor, int bgColor,
                                              CharSequence actionText, int actionTextColor) {
        showSnackbarx(parent, text, duration, textColor, bgColor,
                actionText, actionTextColor);
    }
    ...
    private static void showSnackbarx(View parent, CharSequence text, int duration, int textColor, int bgColor,
                                     CharSequence actionText, int actionTextColor) {
        switch (duration) {
            default:
            case Snackbar.LENGTH_SHORT:
        ...
        if (actionText != null && actionText.length() > 0) {
            snackbarWeakReference.get().setActionTextColor(actionTextColor);
            snackbarWeakReference.get().setAction(actionText, new View.OnClickListener() {
                @Override
